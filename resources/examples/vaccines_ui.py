...
class StatusBar(UI):
    ...
    def __init__(self, config: Config, painter: Painter, country):
    ...
    def build(self) -> Container:
        # Status Bar Boxes
        status_bar_left = Container(width=int(self.config.main.display_width_pixels * 0.7),
                                    display=Display.INLINE,
                                    padding=Padding(top=1, bottom=1),
                                    name="status_bar_left")

        # Stock symbol and currency conversion information
        status_bar_left.add(self.paint_text(self.country))

        # Date and time
        status_bar_right = Container(int(self.config.main.display_width_pixels * 0.3),
                                     align=Align.RIGHT,
                                     display=Display.INLINE,
